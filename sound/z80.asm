...
zWaitDACLoop:
   ...
   if OptimizeDriver=0
	...
	jp	nc,zPlay_SegaPCM				; If yes, branch
   endif
	ld	de,0							; de = 0
...
zPlayPCMLoop:
   ...
   if OptimizeDriver=0
	...
	jr	nz,zCheckForSamples				; If it is set, we need to get a new sample
   endif
...
; This is to keep the samples at a similar speed.
zPCM_Table:
	dw	zDAC_Sample1	; Kick sample
	dw	(zDAC_Sample1_End-zDAC_Sample1)
	dw	0017h+1			; Pitch = 17h
	dw	0000h
...
zDAC_Sample3_End:
	...
	restore
	padding off
	!org (Kos_Z80+Size_of_Snd_driver_guess)
