...
; AS-specific macros and assembler settings
		CPU 68000
		include "s1.macrosetup.asm"

; >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
; Equates section - Names for variables.
		include "s1.constants.asm"

; >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
; Simplifying macros and functions
		include "s1.macros.asm"
...
Vectors:	dc.l $FFFE00, EntryPoint, BusError, AddressError
		...
		dc.l PalToCRAM,	ErrorTrap, V_Int, ErrorTrap
...
SetupValues:	dc.w $8000		; XREF: PortA_Ok
		...
		dc.l VDP_data_port
		dc.l VDP_control_port	; address for VDP registers
...
-		move.l	d7,(a6)+
	...
	if skipChecksumCheck=0	; Might as-well free up 4 bytes of RAM.
...
GameClrRAM:
		...
		bsr.w	JoypadInit
		move.b	#0,(Game_Mode).w ; set Game Mode to Sega Screen
...
CheckSumError:
		...
		moveq	#$3F,d7
-		move.w	#$E,(VDP_data_port).l	; fill screen with colour red
		dbf	d7,-		; repeat $3F more times

CheckSum_FailedLoop:
		bra.s	CheckSum_FailedLoop
	endif
; ===========================================================================
...
Error_LoadGfx:
		...
		move.l	#$46040003,(VDP_control_port).l ; position
...
asc_534:	dc.b "@ERO DIVIDE        "	; "@" appears as a "Z" in-game
...
Vint_SwitchTbl:	dc.w Vint_Lag-Vint_SwitchTbl, loc_C32-Vint_SwitchTbl
		dc.w loc_C44-Vint_SwitchTbl, loc_C5E-Vint_SwitchTbl
		dc.w loc_C6E-Vint_SwitchTbl, loc_DA6-Vint_SwitchTbl
		dc.w loc_E72-Vint_SwitchTbl, loc_F8A-Vint_SwitchTbl
		dc.w loc_C64-Vint_SwitchTbl, loc_F9A-Vint_SwitchTbl
		dc.w loc_C36-Vint_SwitchTbl, loc_FA6-Vint_SwitchTbl
		dc.w loc_E72-Vint_SwitchTbl
; ===========================================================================
; loc_B88:
Vint_Lag:				; XREF: V_Int; Vint_SwitchTbl
...
loc_C32:				; XREF: Vint_SwitchTbl
		bsr.w	Do_ControllerPal

loc_C36:				; XREF: Vint_SwitchTbl
...
; tsub_106E:
Do_ControllerPal:				; XREF: loc_C32; et al
		stopZ80
		bsr.w	ReadJoypads
		tst.b	($FFFFF64E).w
		bne.s	loc_10B0
...
loc_10B0:				; XREF: Do_ControllerPal
		lea	(VDP_control_port).l,a5
		move.l	#$94009340,(a5)
		move.l	#$96FD9540,(a5)
		move.w	#$977F,(a5)
...
loc_10D4:				; XREF: Do_ControllerPal
		lea	(VDP_control_port).l,a5
		move.l	#$94019340,(a5)
		move.l	#$96FC9500,(a5)
		move.w	#$977F,(a5)
...
JoypadInit:				; XREF: GameClrRAM
		...
		move.b	d0,(Z80_Port_1_Control+1).l	; init port 3 (expansion/extra)
		startZ80
		rts	
...
VDP_ClrCRAM:
		...
		move.w	#$9780,(a5)
		move.l	#$40000080,(a5)
		move.w	#0,(VDP_data_port).l	; clear	the screen
...
; ===========================================================================
VDPSetupArray:	dc.w $8004, $8134, $8230, $8328
...
+
		andi.w	#$7FFF,d2
; Because this line is initalized before the decompression, it's not set to 0, causing the game to jump there, resulting in a crash.
; Move this line before the "+" label to fix the issue.
...
; sub_1642:
ProcessDPLC:				; XREF: loc_C44; loc_F54; loc_F9A
		tst.w	(Plc_Buffer_Reg18).w
		beq.w	+	; rts
...
loc_19C0:
		lea	(Normal_palette_line3+$16).w,a1
		move.l	(a0,d0.w),(a1)+
		move.l	4(a0,d0.w),(a1)
		lea	($FFFFFAD6).w,a1
		move.l	(a0,d0.w),(a1)+
...
loc_1A0A:
		...
		add.w	d1,d0
		lea	(Pal_LZCyc2).l,a0
		lea	(Normal_palette_line4+$16).w,a1
		move.l	(a0,d0.w),(a1)+
		move.w	4(a0,d0.w),(a1)
		lea	(Pal_LZCyc3).l,a0
		lea	($FFFFFAF6).w,a1
...
PalCycle_SYZ:				; XREF: PalCycle
		...
		lea	(Normal_palette_line4+$E).w,a1
		move.l	(a0,d0.w),(a1)+
		move.l	4(a0,d0.w),(a1)
...
loc_1B52:
		move.w	d0,(PalCycle_Frame).w
		add.w	d0,d0
		lea	(Normal_palette_line3+$18).w,a1
		move.l	(a0,d0.w),(a1)+
		move.w	4(a0,d0.w),(a1)
...
; ===========================================================================
Pal_TitleCyc:	binclude	pallet/c_title.bin
Pal_GHZCyc:	binclude	pallet/c_ghz.bin
Pal_LZCyc1:	binclude	pallet/c_lz_wat.bin	; waterfalls pallet
Pal_LZCyc2:	binclude	pallet/c_lz_bel.bin	; conveyor belt pallet
Pal_LZCyc3:	binclude	pallet/c_lz_buw.bin	; conveyor belt (underwater) pallet
Pal_SBZ3Cyc1:	binclude	pallet/c_sbz3_w.bin	; waterfalls pallet
Pal_SLZCyc:	binclude	pallet/c_slz.bin
Pal_SYZCyc1:	binclude	pallet/c_syz_1.bin
...
Pal_SBZCyc3:	binclude	pallet/c_sbz_3.bin
Pal_SBZCyc4:	binclude	pallet/c_sbz_4.bin
Pal_SBZCyc5:	binclude	pallet/c_sbz_5.bin
Pal_SBZCyc6:	binclude	pallet/c_sbz_6.bin
Pal_SBZCyc7:	binclude	pallet/c_sbz_7.bin
Pal_SBZCyc8:	binclude	pallet/c_sbz_8.bin
Pal_SBZCyc9:	binclude	pallet/c_sbz_9.bin
Pal_SBZCyc10:	binclude	pallet/c_sbz_10.bin
; ---------------------------------------------------------------------------
...
Pal_Sega1:	binclude	pallet/sega1.bin
Pal_Sega2:	binclude	pallet/sega2.bin
...
; Pallet data
; ---------------------------------------------------------------------------
Pal_SegaBG:	binclude	pallet/sega_bg.bin
Pal_Title:	binclude	pallet/title.bin
Pal_LevelSel:	binclude	pallet/levelsel.bin
Pal_Sonic:	binclude	pallet/sonic.bin
Pal_GHZ:	binclude	pallet/ghz.bin
Pal_LZ:		binclude	pallet/lz.bin
Pal_LZWater:	binclude	pallet/lz_uw.bin	; LZ underwater pallets
Pal_MZ:		binclude	pallet/mz.bin
Pal_SLZ:	binclude	pallet/slz.bin
Pal_SYZ:	binclude	pallet/syz.bin
Pal_SBZ1:	binclude	pallet/sbz_act1.bin	; SBZ act 1 pallets
Pal_SBZ2:	binclude	pallet/sbz_act2.bin	; SBZ act 2 & Final Zone pallets
Pal_Special:	binclude	pallet/special.bin	; special stage pallets
Pal_SBZ3:	binclude	pallet/sbz_act3.bin	; SBZ act 3 pallets
Pal_SBZ3Water:	binclude	pallet/sbz_a3uw.bin	; SBZ act 3 (underwater) pallets
Pal_LZSonWater:	binclude	pallet/son_lzuw.bin	; Sonic (underwater in LZ) pallet
Pal_SBZ3SonWat:	binclude	pallet/son_sbzu.bin	; Sonic (underwater in SBZ act 3) pallet
Pal_SpeResult:	binclude	pallet/ssresult.bin	; special stage results screen pallets
Pal_SpeContinue:binclude	pallet/sscontin.bin	; special stage results screen continue pallet
Pal_Ending:	binclude	pallet/ending.bin	; ending sequence pallets
...
Title_ClrPallet:
		...
		bsr.w	NemDec
		move.l	#$62000002,(VDP_control_port).l
...
Title_ClrObjRam2:
		...
		move.b	#3,($FFFFD0C0+mapping_frame).w
		move.b	#$F,($FFFFD100).w
		move.b	#2,($FFFFD100+mapping_frame).w
		jsr	(ObjectsLoad).l
		bsr.w	DeformBgLayer
		jsr	(BuildSprites).l
		moveq	#0,d0
...
loc_317C:
		...
		bsr.w	RunPLC_RAM
		move.w	($FFFFD000+x_pos).w,d0
		addq.w	#2,d0
		move.w	d0,($FFFFD000+x_pos).w ; move	Sonic to the right
...
Title_ChkRegion:
		tst.b	(Graphics_Flags).w	; check	if the machine is US or	Japanese
...
Title_EnterCheat:			; XREF: Title_ChkRegion
		...
		addq.w	#1,(Correct_cheat_entries).w ; next	button press
		tst.b	d0
		bne.s	Title_CountC
...
Title_CountC:
		...
		addq.w	#1,(Correct_cheat_entries_2).w ; increment C button counter
...
LevelSelect:
		...
		addi.w	#$80,d0
		tst.b	(Hidden_credits_flag).w	; is Japanese Credits cheat on?
...
loc_3422:
		move.w	#1,(Demo_mode_flag).w ; turn	demo mode on
...
; ---------------------------------------------------------------------------
Demo_Levels:	binclude	misc/dm_ord1.bin
		align 2
...
loc_3550:
		move.l	#$6C300003,(VDP_control_port).l ; screen	position (sound	test)
		move.w	($FFFFFF84).w,d0
		addi.w	#$80,d0
		move.b	d0,d2
		lsr.b	#4,d0
...
Level_ChkWater:
		...
		move.w	#$60,($FFFFD780+x_pos).w
		move.b	#$1B,($FFFFD7C0).w
		move.w	#$120,($FFFFD7C0+x_pos).w
...
Level_Demo:
		...
		move.w	#540,(Demo_Time_left).w
		cmpi.w	#4,(Ending_demo_number).w
		bne.s	Level_ChkWaterPal
		move.w	#510,(Demo_Time_left).w
...
DynWater_LZ3:				; XREF: DynWater_Index
		...
		cmpi.w	#$600,d0
		bcs.s	loc_3D54
		cmpi.w	#$3C0,($FFFFD000+y_pos).w
		bcs.s	loc_3D54
		cmpi.w	#$600,($FFFFD000+y_pos).w
		bcc.s	loc_3D54
		move.w	#$4C8,d1
...
LZWind_Move:
		...
		move.w	#0,y_vel(a1)
		move.b	#$F,anim(a1)	; use floating animation
		bset	#1,status(a1)
		btst	#0,(Ctrl_1_Held_Logical).w ; is up pressed?
...
SignpostArtLoad:			; XREF: Level
		...
		tst.b	($FFFFFE1E).w
		beq.s	Signpost_Exit
		cmp.w	(Camera_BG_X_pos_P2).w,d1
		beq.s	Signpost_Exit
		move.w	d1,(Camera_BG_X_pos_P2).w ; move	left boundary to current screen	position
		moveq	#$12,d0
...
; ===========================================================================
Demo_GHZ:	binclude	demodata/i_ghz.bin
Demo_MZ:	binclude	demodata/i_mz.bin
Demo_SYZ:	binclude	demodata/i_syz.bin
Demo_SS:	binclude	demodata/i_ss.bin
; ===========================================================================
...
Pal_SSCyc1:	binclude	pallet/c_ss_1.bin
		align 2
Pal_SSCyc2:	binclude	pallet/c_ss_2.bin
		align 2
...
Cont_ClrObjRam:
		...
		bsr.w	NemDec
		move.l	#$6A200002,(VDP_control_port).l
		...
		move.b	#3,($FFFFD080+priority).w
		move.b	#4,($FFFFD080+mapping_frame).w
...
loc_4DF2:
		jsr	(ObjectsLoad).l
		jsr	(BuildSprites).l
		cmpi.w	#$180,($FFFFD000+x_pos).w ; has Sonic	run off	screen?
...
Obj80_MiniSonLoop:
		_move.b	#$80,0(a1)	; load mini Sonic object
		move.w	(a2)+,x_pos(a1)
		tst.b	d2
		beq.s	loc_4EEA
		subi.w	#$A,x_pos(a1)
...
Obj81_Main:				; XREF: Obj81_Index
		...
		move.b	#$1D,anim(a0)	; use "floating" animation
		move.w	#$400,y_vel(a0)	; make Sonic fall from above

Obj81_ChkLand:				; XREF: Obj81_Index
		cmpi.w	#$1A0,y_pos(a0)	; has Sonic landed yet?
		bne.s	Obj81_ShowFall	; if not, branch
		addq.b	#2,routine(a0)
		clr.w	y_vel(a0)		; stop Sonic falling
		move.l	#Map_obj80,4(a0)
		move.w	#$8500,2(a0)
		move.b	#0,anim(a0)
		bra.s	Obj81_Animate
...
Obj81_GetUp:				; XREF: Obj81_Animate
		...
		move.l	#Map_Sonic,4(a0)
		move.w	#$780,2(a0)
		move.b	#$1E,anim(a0)	; use "getting up" animation
		clr.w	inertia(a0)
		subq.w	#8,y_pos(a0)
		move.b	#$E0,d0
		bsr.w	PlaySound_Special ; fade out music
...
Obj81_Run:				; XREF: Obj81_Index
		cmpi.w	#$800,inertia(a0)	; check	Sonic's "run speed" (not moving)
		bne.s	Obj81_AddSpeed	; if too low, branch
		move.w	#$1000,x_vel(a0)	; move Sonic to	the right
		bra.s	Obj81_ShowRun
; ===========================================================================
...
End_LoadSonic:
		move.b	#1,($FFFFD000).w ; load	Sonic object
		bset	#0,($FFFFD000+status).w ; make	Sonic face left
		move.b	#1,(Control_Locked).w ; lock	controls
		move.w	#$400,(Ctrl_1_Logical).w ; move Sonic to the left
		move.w	#$F800,($FFFFD000+inertia).w ; set Sonic's speed
		move.b	#$21,($FFFFD040).w ; load HUD object
		jsr	(ObjectsManager).l
		jsr	(ObjectsLoad).l
		jsr	(BuildSprites).l
...
End_MoveSonic:				; XREF: End_MainLoop
		move.b	(End_SonicUnk).w,d0
		bne.s	End_MoveSonic2
		cmpi.w	#$90,($FFFFD000+x_pos).w ; has Sonic passed $90 on x-axis?
		bcc.s	End_MoveSonExit	; if not, branch
		addq.b	#2,(End_SonicUnk).w
...
End_MoveSonic2:				; XREF: End_MoveSonic
		...
		cmpi.w	#$A0,($FFFFD000+x_pos).w ; has Sonic passed $A0 on x-axis?
		bcs.s	End_MoveSonExit	; if not, branch
		addq.b	#2,(End_SonicUnk).w
		moveq	#0,d0
		move.b	d0,(Control_Locked).w
		move.w	d0,(Ctrl_1_Logical).w ; stop Sonic moving
		move.w	d0,($FFFFD000+inertia).w
		move.b	#$81,(Freeze_flag).w
		move.b	#3,($FFFFD000+mapping_frame).w
		move.w	#$505,($FFFFD000+anim).w ; use "standing" animation
		move.b	#3,($FFFFD000+anim_frame_duration).w
		rts	
; ===========================================================================
...
Obj88_Main:				; XREF: Obj88_Index
		cmpi.b	#2,($FFFFD000+mapping_frame).w
		beq.s	Obj88_Main2
		addq.l	#4,sp
		rts	
; ===========================================================================
...
Obj88_Main2:				; XREF: Obj88_Main
		move.w	($FFFFD000+x_pos).w,x_pos(a0) ; match X position with Sonic
		move.w	($FFFFD000+y_pos).w,y_pos(a0) ; match Y position	with Sonic
		movea.l	a0,a1
		moveq	#0,d3
		moveq	#1,d2
		moveq	#5,d1
...
Obj88_MainLoop:
		...
		move.w	x_pos(a0),$38(a1)
		move.w	y_pos(a0),$3A(a1)
		move.b	d2,anim(a1)
...
Cred_ClrObjRam:
		...
		move.l	#$74000002,(VDP_control_port).l
...
EndingDemoLoad:				; XREF: Credits
		...
		move.w	#$8001,(Demo_mode_flag).w ; force demo mode
...
; ---------------------------------------------------------------------------
EndDemo_Levels:	binclude	misc/dm_ord2.bin
...
Obj8B_Main:				; XREF: Obj8B_Index
		...
		move.w	#9,(Ending_demo_number).w ; use "TRY AGAIN" text
		move.b	#$8C,($FFFFD800).w ; load emeralds object on "TRY AGAIN" screen
		move.b	#0,anim(a0)	; use "TRY AGAIN" animation
...
loc_5B42:
		...
		addq.b	#1,d2
		move.b	#$80,angle(a1)
		move.b	d3,anim_frame_duration(a1)
		move.b	d3,anim_delay(a1)
		addi.w	#$A,d3
		lea	$40(a1),a1
...
loc_5B8C:
		clr.w	$3E(a0)
		move.b	anim_delay(a0),anim_frame_duration(a0)
...
; ---------------------------------------------------------------------------
Demo_EndGHZ1:	binclude	demodata/e_ghz1.bin
		align 2
Demo_EndMZ:	binclude	demodata/e_mz.bin
		align 2
Demo_EndSYZ:	binclude	demodata/e_syz.bin
		align 2
Demo_EndLZ:	binclude	demodata/e_lz.bin
		align 2
Demo_EndSLZ:	binclude	demodata/e_slz.bin
		align 2
Demo_EndSBZ1:	binclude	demodata/e_sbz1.bin
		align 2
Demo_EndSBZ2:	binclude	demodata/e_sbz2.bin
		align 2
Demo_EndGHZ2:	binclude	demodata/e_ghz2.bin
		align 2
...
LevSz_ChkLamp:				; XREF: LevelSizeLoad
		...
		jsr	(Obj79_LoadInfo).l
		move.w	($FFFFD000+x_pos).w,d1
		move.w	($FFFFD000+y_pos).w,d0
		bra.s	loc_60D0
; ===========================================================================
...
LevSz_SonicPos:
		moveq	#0,d1
		move.w	(a1)+,d1
		move.w	d1,($FFFFD000+x_pos).w ; set Sonic's position on x-axis
		moveq	#0,d0
		move.w	(a1),d0
		move.w	d0,($FFFFD000+y_pos).w ; set Sonic's position on y-axis
...
; ---------------------------------------------------------------------------
; Format - 4 bytes per zone, referring to which 256x256 evoke special align 2ts:
; loop,	loop, tunnel, tunnel
; ---------------------------------------------------------------------------
LoopTileNums:	binclude	misc/loopnums.bin
		align 2
...
loc_628E:
		...
		move.w	(Camera_X_pos).w,($FFFFF61A).w
		move.w	(Camera_Y_pos).w,($FFFFF616).w
		move.w	(Camera_BG_X_pos).w,($FFFFF61C).w
		move.w	(Camera_BG_Y_pos).w,($FFFFF618).w
		move.w	(Camera_BG3_X_pos).w,($FFFFF620).w
		move.w	(Camera_BG3_Y_pos).w,($FFFFF61E).w
		moveq	#0,d0
		move.b	($FFFFFE10).w,d0
		add.w	d0,d0
...
loc_65E4:
		...
		move.w	d1,(Camera_Unk).w
		rts	
; ===========================================================================

loc_65F6:				; XREF: ScrollHoriz2
		add.w	(Camera_X_pos).w,d0
		cmp.w	(Camera_BG_X_pos_P2).w,d0
		bgt.s	loc_65E4
		move.w	(Camera_BG_X_pos_P2).w,d0
		bra.s	loc_65E4
...
loc_665C:
		cmpi.w	#$60,(Camera_Unk3).w
		bne.s	loc_6684
		move.w	($FFFFD000+inertia).w,d1
		bpl.s	loc_666C
		neg.w	d1
...
loc_66CC:
		cmp.w	(Camera_BG_Y_pos_P2).w,d1
		bgt.s	loc_6724
		cmpi.w	#-$100,d1
		bgt.s	loc_66F0
		andi.w	#$7FF,d1
		andi.w	#$7FF,($FFFFD000+y_pos).w
...
loc_6EB0:
		...
		bsr.w	SingleObjLoad
		bne.s	loc_6ED0
		_move.b	#$3D,0(a1)	; load GHZ boss	object
...
Resize_GHZ3end:
		move.w	(Camera_X_pos).w,(Camera_BG_X_pos_P2).w
		rts	
; ===========================================================================
; ---------------------------------------------------------------------------
...
loc_6F28:
		...
		bsr.w	SingleObjLoad
		bne.s	loc_6F4A
		_move.b	#$77,0(a1)	; load LZ boss object
...
Resize_SBZ3:
		...
		bcs.s	locret_6F8C
		cmpi.w	#$18,($FFFFD000+y_pos).w ; has Sonic reached the top of the level?
...
loc_6FF8:
		move.w	#0,(Camera_BG_Y_pos_P2).w
		cmpi.w	#$E00,(Camera_X_pos).w
		bcc.s	locret_702C
		move.w	#$340,(Camera_BG_Y_pos_P2).w
		move.w	#$340,($FFFFF726).w
...
loc_703C:
		...
		bcs.s	locret_704E
		move.w	#$500,(Camera_BG_Y_pos_P2).w
		addq.b	#2,($FFFFF742).w
...
Resize_MZ3boss:
		...
		bsr.w	SingleObjLoad
		bne.s	loc_70D0
		_move.b	#$73,0(a1)	; load MZ boss object
...
Obj18_SetFrame:
		move.b	d1,mapping_frame(a0)	; set frame to d1
...
Obj18_Type0C:
		move.w	$34(a0),d0
		move.b	(Oscillating_Data+$C).w,d1 ; load	platform-motion	variable
		neg.b	d1		; reverse platform-motion
		addi.b	#$30,d1
		bra.s	Obj18_02_Move
; ===========================================================================
...
Obj1D_Main:				; XREF: Obj1D_Index
		...
		move.w	#$4000,2(a0)
		move.b	#4,1(a0)
		move.w	y_pos(a0),$30(a0)	; save position	on y-axis
		move.b	#$10,width_pixels(a0)
		move.b	#5,priority(a0)

Obj1D_Action:				; XREF: Obj1D_Index
		move.w	$30(a0),y_pos(a0)	; restore position on y-axis
		move.w	#$10,d1
...
Obj1E_MakeBall:				; XREF: Obj1E_Action
		...
		bsr.w	SingleObjLoad
		bne.s	loc_8C1A
		_move.b	#$20,0(a1)	; load cannonball object ($20)
		move.w	x_pos(a0),x_pos(a1)
		move.w	y_pos(a0),y_pos(a1)
...
Obj20_ChkExplode:			; XREF: Obj20_Bounce
		...
		_move.b	#$24,0(a0)
		_move.b	#$3F,0(a0)	; change object	to an explosion	($3F)
...
Obj20_Animate:				; XREF: Obj20_ChkExplode
		...
		bpl.s	Obj20_Display
		move.b	#5,anim_frame_duration(a0)	; set frame duration to	5 frames
...
Obj24_Animate:				; XREF: Obj24_Index
		subq.b	#1,anim_frame_duration(a0)	; subtract 1 from frame	duration
		bpl.s	Obj24_Display
		move.b	#9,anim_frame_duration(a0)	; set frame duration to	9 frames
		addq.b	#1,mapping_frame(a0)	; next frame
		cmpi.b	#4,mapping_frame(a0)	; is the final frame (04) displayed?
...
Obj27_Main:				; XREF: Obj27_Index
		...
		move.b	#0,collision_flags(a0)
		move.b	#$C,width_pixels(a0)
		move.b	#7,anim_frame_duration(a0)	; set frame duration to	7 frames
		move.b	#0,mapping_frame(a0)
		move.w	#$C1,d0
...
Obj27_Animate:				; XREF: Obj27_Index
		...
		move.b	#7,anim_frame_duration(a0)	; set frame duration to	7 frames
		addq.b	#1,mapping_frame(a0)	; next frame
		cmpi.b	#5,mapping_frame(a0)	; is the final frame (05) displayed?
		beq.w	DeleteObject	; if yes, branch
...
Obj29_Main:				; XREF: Obj29_Index
		...
		move.b	#1,priority(a0)
		move.b	#8,width_pixels(a0)
		move.w	#-$300,y_vel(a0)	; move object upwards
...
Obj22_Stop:				; XREF: Obj22_SetNrSonic
		subq.b	#2,routine_secondary(a0)	; run "Obj22_Fire" routine
...
loc_9BBA:				; XREF: Obj25_Main
		_move.b	#$25,0(a1)	; load ring object
		addq.b	#2,routine(a1)
...
Obj4B_Collect:				; XREF: Obj4B_Index
		...
		bsr.w	SingleObjLoad
		bne.w	Obj4B_PlaySnd
		_move.b	#$7C,0(a1)	; load giant ring flash	object
		move.w	x_pos(a0),x_pos(a1)
		move.w	y_pos(a0),y_pos(a1)
		move.l	a0,$3C(a1)
		move.w	($FFFFD000+x_pos).w,d0
...
Obj7C_Collect:				; XREF: Obj7C_ChkDel
		...
		move.b	#1,anim_frame_duration(a0)
		addq.b	#1,mapping_frame(a0)
		cmpi.b	#8,mapping_frame(a0)	; has animation	finished?
		bcc.s	Obj7C_End	; if yes, branch
		cmpi.b	#3,mapping_frame(a0)	; is 3rd frame displayed?
		bne.s	locret_9F76	; if not, branch
		movea.l	$3C(a0),a1
		move.b	#6,routine(a1)	; delete giant ring object (Obj4B)
		move.b	#$1C,($FFFFD000+anim).w ; make Sonic	invisible
...
Obj26_Solid:				; XREF: Obj26_Index
		move.b	routine_secondary(a0),d0	; is monitor set to fall?
...
Obj26_SetBroken:
		...
		move.b	respawn_index(a0),d0
		bset	#0,2(a2,d0.w)
		move.b	#9,anim(a0)	; set monitor type to broken
		bra.w	DisplaySprite
; ===========================================================================
; ---------------------------------------------------------------------------
...
Obj2E_ChkEggman:			; XREF: Obj2E_Move
		addq.b	#2,routine(a0)
		move.w	#29,anim_frame_duration(a0)
		move.b	anim(a0),d0
...
AnimateSprite:
		...
		move.b	d0,next_anim(a0)	; set to "no restart"
...
Obj2C_Turn:				; XREF: Obj2C_Index
		...
		move.b	#1,next_anim(a0)	; reset	animation
...
Obj2D_Main:				; XREF: Obj2D_Index
		...
		move.b	#5,collision_flags(a0)
		move.b	#$C,width_pixels(a0)
		addq.b	#6,routine_secondary(a0)	; run "Obj2D_ChkSonic" routine
		move.b	#2,anim(a0)
...
loc_B01C:
		...
		bne.s	loc_B07A
		_move.b	#$35,0(a1)	; load sitting flame object
		move.w	x_pos(a0),x_pos(a1)
		move.w	$2C(a0),$2C(a1)
		addq.w	#8,$2C(a1)
		subq.w	#3,$2C(a1)
...
Obj31_MakeStomper:			; XREF: Obj31_Main
		...
		move.b	#$38,width_pixels(a1)
		move.b	#$90,collision_flags(a1)
		addq.w	#1,d1
...
Obj32_Pressed:				; XREF: Obj32_Index
		...
		move.w	x_pos(a0),d4
		bsr.w	SolidObject
		bclr	#0,mapping_frame(a0)	; use "unpressed" frame
		move.b	subtype(a0),d0
		andi.w	#$F,d0
...
loc_BDD6:
		bset	d3,(a3)
		bset	#0,mapping_frame(a0)	; use "pressed"	frame
...
Obj33_LoadLava:
		bsr.w	SingleObjLoad
		bne.s	locret_C184
		_move.b	#$4C,0(a1)	; load lava geyser object
		move.w	x_pos(a0),x_pos(a1)
		add.w	d2,x_pos(a1)
		move.w	y_pos(a0),y_pos(a1)
		addi.w	#$10,y_pos(a1)
...
Obj34_ChkPos2:				; XREF: Obj34_Wait
		...
		moveq	#$20,d1
		move.w	$32(a0),d0
		cmp.w	x_pos(a0),d0	; has item reached the finish position?
...
Obj39_ChgMode:				; XREF: Obj39_Wait
		...
		move.b	#0,(Game_Mode).w ; set mode to 0 (Sega screen)
		bra.s	Obj39_Display
; ===========================================================================
...
Obj3A_ChkPos:				; XREF: Obj3A_Index
		moveq	#$10,d1		; set horizontal speed
		move.w	$30(a0),d0
		cmp.w	x_pos(a0),d0	; has item reached its target position?
...
Obj3A_ChkSS:				; XREF: Obj3A_NextLevel
		...
		tst.b	(Bonuses_flag).w	; has Sonic jumped into	a giant	ring?
...
; Level	order array
; ---------------------------------------------------------------------------
LevelOrder:	binclude	misc/lvl_ord.bin
		align 2
; ===========================================================================
...
Obj3A_ChkPos2:				; XREF: Obj3A_Index
		...
		move.w	$32(a0),d0
		cmp.w	x_pos(a0),d0	; has item reached its finish position?
...
Obj3A_SBZ2:				; XREF: Obj3A_ChkPos2
		...
		bne.w	DeleteObject
		addq.b	#2,routine(a0)
		clr.b	(Control_Locked).w	; unlock controls
		move.w	#$8D,d0
...
Obj7E_RingBonus:			; XREF: Obj7E_Index
		bsr.w	DisplaySprite
		move.b	#1,(Update_Bonus_score).w ; set ring bonus update flag
		tst.w	(Bonus_Countdown_2).w	; is ring bonus	= zero?
...
loc_C8C4:				; XREF: Obj7E_RingBonus
		...
		move.w	#60,anim_frame_duration(a0)	; set time delay to 1 second
		addq.b	#4,routine(a0)	; goto "Obj7E_Continue"	routine
...
Obj7E_Continue:				; XREF: Obj7E_Index
		...
		addq.b	#2,routine(a0)
		move.w	#360,anim_frame_duration(a0)	; set time delay to 6 seconds
		bra.w	DisplaySprite
; ===========================================================================
...
Obj7F_Flash:				; XREF: Obj7F_Index
		move.b	mapping_frame(a0),d0
		move.b	#6,mapping_frame(a0)	; load 6th frame (blank)
		cmpi.b	#6,d0
		bne.s	Obj7F_Display
		move.b	anim(a0),mapping_frame(a0)	; load visible frame
...
Obj36_Solid:				; XREF: Obj36_Index
		...
		move.w	#4,d2
		cmpi.b	#5,mapping_frame(a0)	; is object type $5x ?
...
Obj3C_Solid:				; XREF: Obj3C_Index
		move.w	($FFFFD000+x_vel).w,$30(a0) ;	load Sonic's horizontal speed
		move.w	#$1B,d1
		move.w	#$20,d2
		move.w	#$20,d3
		move.w	x_pos(a0),d4
...
OPL_Main:
	...
	; initialize each object load address with the first object in the layout
		...
		adda.w	2(a1,d0.w),a1
		move.l	a1,(Obj_load_addr_3).w	; unused besides this one write
		move.l	a1,(Obj_load_addr_4).w	; unused besides this one write
		lea	(Object_Respawn_Table).w,a2
...
; loc_DA3C:
ChkLoadObj:
; This first line doesn't make sense, it should be 2, not 4.
...
Obj41_Up:				; XREF: Obj41_Index
		...
		move.w	x_pos(a0),d4
		bsr.w	SolidObject
		tst.b	routine_secondary(a0)		; is Sonic on top of the spring?
...
Obj41_BounceUp:				; XREF: Obj41_Up
		addq.b	#2,routine(a0)
		addq.w	#8,y_pos(a1)
		move.w	$30(a0),y_vel(a1)	; move Sonic upwards
		bset	#1,status(a1)
		bclr	#3,status(a1)
...
Obj41_BounceLR:				; XREF: Obj41_LR
		addq.b	#2,routine(a0)
		move.w	$30(a0),x_vel(a1)	; move Sonic to	the left
		addq.w	#8,x_pos(a1)
...
Obj41_ResetLR:				; XREF: Obj41_Index
		move.b	#2,next_anim(a0)	; reset	animation
...
Obj43_RollChk:				; XREF: Obj43_Index2
		...
		move.b	#$8E,collision_flags(a0)	; make Roller invincible
...
Obj13_Main:				; XREF: Obj13_Index
		...
		lsr.w	#4,d0
		andi.w	#$F,d0
		move.b	Obj13_Rates(pc,d0.w),anim_delay(a0)
		move.b	anim_delay(a0),anim_frame_duration(a0)	; set time delay for lava balls
		andi.b	#$F,subtype(a0)

Obj13_MakeLava:				; XREF: Obj13_Index
		subq.b	#1,anim_frame_duration(a0)	; subtract 1 from time delay
		bne.s	locret_E302	; if time still	remains, branch
		move.b	anim_delay(a0),anim_frame_duration(a0)	; reset	time delay
		bsr.w	ChkObjOnScreen
		bne.s	locret_E302
		bsr.w	SingleObjLoad
		bne.s	locret_E302
		_move.b	#$14,0(a1)	; load lava ball object
		move.w	x_pos(a0),x_pos(a1)
		move.w	y_pos(a0),y_pos(a1)
		move.b	subtype(a0),subtype(a1)
...
Obj47_Hit:				; XREF: Obj47_Index
		tst.b	collision_property(a0)		; has Sonic touched the	bumper?
...
Obj0D_Touch:				; XREF: Obj0D_Index
		...
		move.w	($FFFFF72A).w,(Camera_BG_X_pos_P2).w ; lock screen position
		addq.b	#2,routine(a0)
...
Obj0D_Spin:				; XREF: Obj0D_Index
		...
		addq.b	#1,anim(a0)	; next spin cycle
		cmpi.b	#3,anim(a0)	; have 3 spin cycles completed?
...
Obj0D_SonicRun:				; XREF: Obj0D_Index
		...
		bne.s	loc_EC70
		move.b	#1,(Control_Locked).w ; lock	controls
		move.w	#$800,(Ctrl_1_Logical).w ; make Sonic run to the right
...
GotThroughAct:				; XREF: Obj3E_EndAct
		tst.b	($FFFFD5C0).w
		bne.s	locret_ECEE
		move.w	($FFFFF72A).w,(Camera_BG_X_pos_P2).w
...
loc_ECD0:
		add.w	d0,d0
		move.w	TimeBonuses(pc,d0.w),(Bonus_Countdown_1).w ; set time bonus
		move.w	($FFFFFE20).w,d0 ; load	number of rings
		mulu.w	#10,d0		; multiply by 10
		move.w	d0,(Bonus_Countdown_2).w ; set ring bonus
		move.w	#$8E,d0
...
Obj4C_MakeLava:				; XREF: Obj4C_Index
		...
		bsr.w	SingleObjLoad2
		bne.s	loc_EE18
		_move.b	#$4D,0(a1)	; load lavafall	object
		move.w	x_pos(a0),x_pos(a1)
		move.w	y_pos(a0),y_pos(a1)
		move.b	subtype(a0),subtype(a1)
		move.l	a0,$3C(a1)
...
Obj54_Main:				; XREF: Obj54_Index
		...
		moveq	#0,d0
		move.b	subtype(a0),d0
		move.b	Obj54_Sizes(pc,d0.w),collision_flags(a0)
...
Obj40_FixToFloor:			; XREF: Obj40_Index2
		...
		bsr.w	SingleObjLoad
		bne.s	locret_F756
		_move.b	#$40,0(a1)	; load exhaust smoke object
		move.w	x_pos(a0),x_pos(a1)
		move.w	y_pos(a0),y_pos(a1)
		move.b	status(a0),status(a1)
		move.b	#2,anim(a1)
...
Obj51_Solid:				; XREF: Obj51_Index
		...
		move.b	($FFFFD000+anim).w,$32(a0) ;	load Sonic's animation number
		move.w	#$1B,d1
		move.w	#$10,d2
		move.w	#$11,d3
		move.w	x_pos(a0),d4
...
Obj57_Main:				; XREF: Obj57_Index
		...
		move.w	x_pos(a0),$3A(a0)
		move.w	y_pos(a0),$38(a0)
		move.b	#$98,collision_flags(a0)	; SYZ specific code (chain hurts Sonic)
		cmpi.b	#1,($FFFFFE10).w ; check if level is LZ
		bne.s	loc_107E8
		move.b	#0,collision_flags(a0)	; LZ specific code (chain doesn"t hurt)
		move.w	#$310,2(a0)
...
loc_10894:
		...
		cmpi.b	#1,($FFFFFE10).w ; check if level is LZ
		bne.s	Obj57_Move
		move.b	#$8B,collision_flags(a0)	; if yes, make last spikeball larger
		move.b	#1,mapping_frame(a0)	; use different	frame
...
Obj59_MakeMulti:			; XREF: Obj59_Index
		...
		bsr.w	SingleObjLoad
		bne.s	Obj59_ChkDel
		_move.b	#$59,0(a1)	; duplicate the	object
		move.w	x_pos(a0),x_pos(a1)
		move.w	y_pos(a0),y_pos(a1)
		move.b	#$E,subtype(a1)
...
Obj5B_MakeBlocks:			; XREF: Obj5B_Main
		_move.b	#$5B,0(a1)	; load another block object
...
Obj0B_Grab:				; XREF: Obj0B_Action
		tst.b	collision_property(a0)		; has Sonic touched the	pole?
		...
		move.b	#1,(Freeze_flag).w ; lock	controls
...
Obj71_Main:				; XREF: Obj71_Index
		...
		addi.w	#$10,d0
		lsr.w	#1,d0
		move.b	d0,width_pixels(a0)	; set object width
...
Obj5E_Main:				; XREF: Obj5E_Index
		...
		bsr.w	SingleObjLoad2
		bne.s	loc_116D2
		_move.b	#$5E,0(a1)	; load spikeball object
		addq.b	#6,routine(a1)
		move.w	x_pos(a0),x_pos(a1)
		move.w	y_pos(a0),y_pos(a1)
		move.b	status(a0),status(a1)
...
Obj5E_Data1:	binclude	misc/slzssaw1.bin
		align 2
Obj5E_Data2:	binclude	misc/slzssaw2.bin
		align 2
; ---------------------------------------------------------------------------
...
Obj5F_Explode:				; XREF: Obj5F_Index2
		subq.w	#1,$30(a0)
		bpl.s	locret_11AD0
		_move.b	#$3F,0(a0)	; change bomb into an explosion
		move.b	#0,routine(a0)
...
Obj5F_MakeFuse:
		...
		bsr.w	SingleObjLoad2
		bne.s	locret_11B5E
		_move.b	#$5F,0(a1)	; load fuse object
		move.w	x_pos(a0),x_pos(a1)
		move.w	y_pos(a0),y_pos(a1)
...
Obj5F_MakeShrap:			; XREF: loc_11B7C
		_move.b	#$5F,0(a1)	; load shrapnel	object
		move.w	x_pos(a0),x_pos(a1)
		move.w	y_pos(a0),y_pos(a1)
		move.b	#6,subtype(a1)
		move.b	#4,anim(a1)
...
Obj62_Main:				; XREF: Obj62_Index
		...
		move.b	subtype(a0),d0	; get object type
		andi.w	#$F,d0		; read only the	2nd digit
		move.b	Obj62_SpitRate(pc,d0.w),anim_delay(a0)	; set fireball spit rate
		move.b	anim_delay(a0),anim_frame_duration(a0)
		andi.b	#$F,subtype(a0)
...
Obj62_MakeFire:				; XREF: Obj62_Index
		...
		bsr.w	SingleObjLoad
		bne.s	Obj62_NoFire
		_move.b	#$62,0(a1)	; load fireball	object
		addq.b	#4,routine(a1)
		move.w	x_pos(a0),x_pos(a1)
		move.w	y_pos(a0),y_pos(a1)
		move.b	1(a0),1(a1)
...
loc_1287C:
		...
		bsr.w	SingleObjLoad
		bne.s	loc_128F8
		_move.b	#$64,0(a1)	; load bubble object
		move.w	x_pos(a0),x_pos(a1)
		jsr	(RandomNumber).l
		andi.w	#$F,d0
		subq.w	#8,d0
...
loc_12C58:
		...
		move.w	($FFFFF604).w,(Ctrl_1_Logical).w ; enable joypad control

loc_12C64:
		btst	#0,(Freeze_flag).w ; are controls	locked?
...
Sonic_LookUp:
		...
		cmpi.w	#$C8,(Camera_Unk3).w
		beq.s	loc_12FC2
		addq.w	#2,(Camera_Unk3).w
		bra.s	loc_12FC2
; ===========================================================================
...
Sonic_Duck:
		...
		cmpi.w	#8,(Camera_Unk3).w
		beq.s	loc_12FC2
		subq.w	#2,(Camera_Unk3).w
		bra.s	loc_12FC2
; ===========================================================================

Obj01_ResetScr:
		cmpi.w	#$60,(Camera_Unk3).w ; is	screen in its default position?
		beq.s	loc_12FC2	; if yes, branch
		bcc.s	loc_12FBE
		addq.w	#4,(Camera_Unk3).w ; move	screen back to default

loc_12FBE:
		subq.w	#2,(Camera_Unk3).w ; move	screen back to default
...
; Sonic 2 changed this to a bhs command.
		...
		addq.w	#4,(Camera_Unk3).w	; either add 2
+		subq.w	#2,(Camera_Unk3).w	; or subtract 2
...
; ---------------------------------------------------------------------------
		...
		tst.w	d1
		bpl.s	locret_13302
		move.w	#0,inertia(a0)	; stop Sonic moving
		move.w	#0,x_vel(a0)
		move.w	#0,y_vel(a0)
...
Sonic_Floor:				; XREF: Obj01_MdJump; Obj01_MdJump2
		...
		move.w	y_vel(a0),d2
		jsr	(CalcAngle).l
		move.b	d0,(unk_FFEC).w
		subi.b	#$20,d0
		move.b	d0,(unk_FFED).w
		andi.b	#$C0,d0
		move.b	d0,(unk_FFEE).w
		cmpi.b	#$40,d0
		beq.w	loc_13680
		cmpi.b	#$80,d0
		beq.w	loc_136E2
...
GameOver:				; XREF: Obj01_Death
		...
		move.b	#1,($FFFFD0C0+mapping_frame).w ; set OVER object to correct frame
		clr.b	($FFFFFE1A).w
...
loc_138D4:
		...
		move.b	#$39,($FFFFD0C0).w ; load OVER object
		move.b	#2,($FFFFD080+mapping_frame).w
		move.b	#3,($FFFFD0C0+mapping_frame).w
		bra.s	loc_138C2
; ===========================================================================
...
Obj0A_ReduceAir:
		...
		bsr.w	ResumeMusic
		move.b	#$81,(Freeze_flag).w ; lock controls
		move.w	#$B2,d0
...
Obj0A_MakeItem:
		...
		jsr	(SingleObjLoad).l
		bne.w	locret_1408C
		_move.b	#$A,0(a1)	; load object
		move.w	($FFFFD000+x_pos).w,x_pos(a1) ; match X position to Sonic
		moveq	#6,d0
		btst	#0,($FFFFD000+status).w
		beq.s	loc_13FF2
		neg.w	d0
		move.b	#$40,angle(a1)
...
loc_13FF2:
		add.w	d0,x_pos(a1)
		move.w	($FFFFD000+y_pos).w,y_pos(a1)
		move.b	#6,subtype(a1)
		tst.w	$2C(a0)
		beq.w	loc_1403E
		andi.w	#7,$3A(a0)
...
Obj38_DoStars:
		addq.b	#2,routine(a0)	; stars	specific code
		move.w	#$55C,2(a0)
		rts	
; ===========================================================================
...
Obj38_Shield:				; XREF: Obj38_Index
		...
		move.w	($FFFFD000+x_pos).w,x_pos(a0)
		move.w	($FFFFD000+y_pos).w,y_pos(a0)
		move.b	($FFFFD000+status).w,status(a0)
		lea	(Ani_obj38).l,a1
		jsr	(AnimateSprite).l
		jmp	(DisplaySprite).l
; ===========================================================================
...
Obj08_Main:				; XREF: Obj08_Index
		...
		move.b	#$10,width_pixels(a0)
		move.w	#$4259,2(a0)
		move.w	($FFFFD000+x_pos).w,x_pos(a0) ; copy x-position from Sonic
...
; ---------------------------------------------------------------------------
; Subroutine pralign 2ting	Sonic from running on walls and	ceilings when he
; touches them
; ---------------------------------------------------------------------------
...
loc_151F0:
		clr.b	(Freeze_flag).w	; unlock controls
		subq.b	#4,routine(a0)
...
Obj6A_Animate01:
		...
		subq.b	#1,anim_frame_duration(a0)
		bpl.s	loc_15A46
		move.b	#2,anim_frame_duration(a0)	; time between frame changes
		bchg	#0,mapping_frame(a0)	; change frame
...
Obj6A_Animate02:
		...
		subq.b	#1,anim_frame_duration(a0)
		bpl.s	loc_15A96
		move.b	#2,anim_frame_duration(a0)
		bchg	#0,mapping_frame(a0)
...
loc_160AA:
		lea	(Ani_obj6C).l,a1
		jsr	(AnimateSprite).l
		btst	#1,mapping_frame(a0)	; has platform vanished?
...
Obj6E_Animate:
		...
		jsr	(AnimateSprite).l
		move.b	#0,collision_flags(a0)
		cmpi.b	#4,mapping_frame(a0)	; is frame number 4 displayed?
		bne.s	Obj6E_Display	; if not, branch
		move.b	#$A4,collision_flags(a0)	; if yes, make object hurt Sonic
...
Obj78_LoadBody:
		...
		_move.b	#$78,0(a1)	; load body segment object
...
loc_16ABC:
		move.b	#$A,routine(a0)	; run "Obj78_Delete" routine
		rts	
; ===========================================================================
...
Obj79_RedLamp:
		...
		move.b	#3,mapping_frame(a0)	; use red lamppost frame
		rts	
; ===========================================================================
...
loc_16F76:
		move.b	#1,mapping_frame(a0)	; use "post only" frame, with no lamp
...
Obj79_StoreInfo:			; XREF: Obj79_HitLamp
		...
		move.w	(Camera_X_pos).w,($FFFFFE40).w 	; screen x-position
		move.w	(Camera_Y_pos).w,($FFFFFE42).w 	; screen y-position
		move.w	(Camera_BG_X_pos).w,($FFFFFE44).w 	; bg position
		move.w	(Camera_BG_Y_pos).w,($FFFFFE46).w 	; bg position
		move.w	(Camera_BG2_X_pos).w,($FFFFFE48).w 	; bg position
		move.w	(Camera_BG2_Y_pos).w,($FFFFFE4A).w 	; bg position
		move.w	(Camera_BG3_X_pos).w,($FFFFFE4C).w 	; bg position
		move.w	(Camera_BG3_Y_pos).w,($FFFFFE4E).w 	; bg position
...
Obj79_LoadInfo:				; XREF: LevelSizeLoad
		...
		move.w	($FFFFFE32).w,($FFFFD000+x_pos).w
		move.w	($FFFFFE34).w,($FFFFD000+y_pos).w
...
loc_170E4:
		...
		subi.w	#$A0,d0
		move.w	d0,(Camera_BG_X_pos_P2).w
...
Obj8A_Main:				; XREF: Obj8A_Index
		...
		move.b	d0,mapping_frame(a0)	; display appropriate sprite
		move.b	#0,1(a0)
		move.b	#0,priority(a0)
...
BossDefeated:
		...
		jsr	(SingleObjLoad).l
		bne.s	locret_178A2
		_move.b	#$3F,0(a1)	; load explosion object
		move.w	x_pos(a0),x_pos(a1)
		move.w	y_pos(a0),y_pos(a1)
		jsr	(RandomNumber).l
		move.w	d0,d1
...
Obj3D_MakeBall:				; XREF: Obj3D_ShipIndex
		...
		jsr	(SingleObjLoad2).l
		bne.s	loc_17910
		_move.b	#$48,0(a1)	; load swinging	ball object
...
Obj48_MakeLinks:
		...
		move.w	x_pos(a0),x_pos(a1)
		move.w	y_pos(a0),y_pos(a1)
		_move.b	#$48,0(a1)	; load chain link object
		move.b	#6,routine(a1)
...
loc_18DAE:
		...
		move.b	#10,anim_delay(a0)	; set frame duration to	10 frames
		move.b	anim_delay(a0),anim_frame_duration(a0)
		bra.w	loc_18FA2
; ===========================================================================
...
loc_18E7A:
		...
		bne.s	loc_18E88
		move.b	#5,anim_delay(a0)

loc_18E88:
		cmpi.w	#$3C,subtype(a0)
		bne.s	loc_18E96
		move.b	#2,anim_delay(a0)
...
Obj82_Main:				; XREF: Obj82_Index
		...
		move.w	#$5A4,y_pos(a0)
		move.b	#$F,collision_flags(a0)
		move.b	#$10,collision_property(a0)
		bclr	#0,status(a0)
		clr.b	routine_secondary(a0)
...
Obj82_FindLoop:	
		...
		bne.s	loc_199D0
		move.w	#$474F,subtype(a1)	; set block to disintegrate
		addq.b	#2,routine_secondary(a0)
		move.b	#1,anim(a0)
...
loc_19C36:				; XREF: Obj83_Index
		subi.b	#$E,anim_frame_duration(a0)
		bcc.s	Obj83_Solid2
		moveq	#-1,d0
		move.b	mapping_frame(a0),d0
		ext.w	d0
...
loc_1A0F2:
		cmpi.w	#$26A0,x_pos(a0)
		bcs.s	loc_1A110
		move.w	#$26A0,x_pos(a0)
		move.w	#$240,x_vel(a0)
		move.w	#-$4C0,y_vel(a0)
		addq.b	#2,$34(a0)
...
loc_1A216:
		cmpi.w	#$2790,($FFFFD000+x_pos).w
		blt.s	loc_1A23A
		move.b	#1,(Control_Locked).w
		move.w	#0,(Ctrl_1_Logical).w
		clr.w	($FFFFD000+inertia).w
		tst.w	y_vel(a0)
		bpl.s	loc_1A248
		move.w	#$100,(Ctrl_1_Logical).w

loc_1A23A:
		cmpi.w	#$27E0,($FFFFD000+x_pos).w
		blt.s	loc_1A248
		move.w	#$27E0,($FFFFD000+x_pos).w

loc_1A248:
		cmpi.w	#$2900,x_pos(a0)
		bcs.s	loc_1A260
		tst.b	1(a0)
		bmi.s	loc_1A260
...
loc_1A35E:
		...
		tst.b	anim_frame_duration(a0)
		bne.s	loc_1A376
		move.b	#$14,anim_frame_duration(a0)
...
Obj3E_ChkOpened:
		tst.b	routine_secondary(a0)		; has the prison been opened?
		beq.s	Obj3E_DoOpen	; if yes, branch
		clr.b	routine_secondary(a0)
		bclr	#3,($FFFFD000+status).w
		bset	#1,($FFFFD000+status).w

Obj3E_DoOpen:
		move.b	#2,mapping_frame(a0)	; use frame number 2 (destroyed	prison)
		rts	
; ===========================================================================
...
; ---------------------------------------------------------------------------
; Object touch response	subroutine - collision_flags(a0) in	the object RAM
; ---------------------------------------------------------------------------
...
Hurt_NoRings:
		tst.w	(Debug_mode_flag).w	; is debug mode	cheat on?
...
SS_LoadData:
		...
		move.w	(a1)+,($FFFFD000+x_pos).w
		move.w	(a1)+,($FFFFD000+y_pos).w
...
loc_1C078:
		move.l	#$6F000001,(VDP_control_port).l ; VRAM address
...
loc_1C2CE:
		...
		bsr.w	LoadTiles
		movea.l	a2,a1
		move.l	#$72000001,(VDP_control_port).l
		move.w	#$F,d1
		bra.w	LoadTiles
; ===========================================================================
...
loc_1C37A:
		...
		lsl.w	#8,d0
		add.w	d0,d0
		move.l	#$68000001,(VDP_control_port).l
...
HudDb_ChkBonus:
		...
		clr.b	(Update_Bonus_score).w
		move.l	#$6E000002,(VDP_control_port).l ; set VRAM address
		moveq	#0,d1
		move.w	(Bonus_Countdown_1).w,d1 ; load	time bonus
		bsr.w	Hud_TimeRingBonus
		moveq	#0,d1
...
HudDb_XY:				; XREF: HudDebug
		move.l	#$5C400003,(VDP_control_port).l ; set VRAM address
		move.w	(Camera_X_pos).w,d1 ; load	camera x-position
		swap	d1
		move.w	($FFFFD000+x_pos).w,d1 ; load	Sonic's x-position
		bsr.s	HudDb_XY2
		move.w	(Camera_Y_pos).w,d1 ; load	camera y-position
		swap	d1
		move.w	($FFFFD000+y_pos).w,d1 ; load	Sonic's y-position
...
ContScrCounter:				; XREF: ContinueScreen
		move.l	#$5F800003,(VDP_control_port).l ; set VRAM address
		lea	(VDP_data_port).l,a6
		lea	(Hud_10).l,a2
		moveq	#1,d6
		moveq	#0,d4
...
; ===========================================================================
Art_Hud:	binclude	artunc/HUD.bin		; 8x16 pixel numbers on HUD
		align 2
Art_LivesNums:	binclude	artunc/livescnt.bin	; 8x8 pixel numbers on lives counter
		align 2
; ===========================================================================
; ---------------------------------------------------------------------------
...
Debug_Main:				; XREF: Debug_Index
		...
		move.w	(Camera_BG_Y_pos_P2).w,($FFFFFEF0).w ; buffer level x-boundary
...
Debug_Exit:
		...
		move.b	d0,($FFFFD000+anim).w
		move.w	d0,x_sub(a0)
		move.w	d0,y_sub(a0)
		move.w	($FFFFFEF0).w,(Camera_BG_Y_pos_P2).w ; restore level boundaries
		...
		move.l	#Map_Sonic,($FFFFD004).w
		move.w	#$780,($FFFFD002).w
		move.b	#2,($FFFFD000+anim).w
		bset	#2,($FFFFD000+status).w
		bset	#1,($FFFFD000+status).w
...
Debug_ShowItem:				; XREF: Debug_Main
		...
		move.b	5(a2,d0.w),mapping_frame(a0) ; load frame	number for item
		rts	
...
Nem_SegaLogo:	binclude	artnem/segalogo.bin	; large Sega logo
		align 2
Eni_SegaLogo:	binclude	mapeni/segalogo.bin	; large Sega logo (mappings)
		align 2
...
Nem_TitleSonic:	binclude	artnem/titleson.bin	; Sonic on title screen
		align 2
Nem_TitleTM:	binclude	artnem/titletm.bin	; TM on title screen
		align 2
Eni_JapNames:	binclude	mapeni/japcreds.bin	; Japanese credits (mappings)
		align 2
Nem_JapNames:	binclude	artnem/japcreds.bin	; Japanese credits
		align 2
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
Nem_Smoke:	binclude	artnem/xxxsmoke.bin	; unused smoke
		align 2
Nem_SyzSparkle:	binclude	artnem/xxxstars.bin	; unused stars
		align 2
Nem_Shield:	binclude	artnem/shield.bin	; shield
		align 2
Nem_Stars:	binclude	artnem/invstars.bin	; invincibility stars
		align 2
Nem_LzSonic:	binclude	artnem/xxxlzson.bin	; unused LZ Sonic holding his breath
		align 2
Nem_UnkFire:	binclude	artnem/xxxfire.bin	; unused fireball
		align 2
Nem_Warp:	binclude	artnem/xxxflash.bin	; unused entry to special stage flash
		align 2
Nem_Goggle:	binclude	artnem/xxxgoggl.bin	; unused goggles
		align 2
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
Nem_SSWalls:	binclude	artnem/sswalls.bin	; special stage walls
		align 2
Eni_SSBg1:	binclude	mapeni/ssbg1.bin	; special stage background (mappings)
		align 2
Nem_SSBgFish:	binclude	artnem/ssbg1.bin	; special stage birds and fish background
		align 2
Eni_SSBg2:	binclude	mapeni/ssbg2.bin	; special stage background (mappings)
		align 2
Nem_SSBgCloud:	binclude	artnem/ssbg2.bin	; special stage clouds background
		align 2
Nem_SSGOAL:	binclude	artnem/ssgoal.bin	; special stage GOAL block
		align 2
Nem_SSRBlock:	binclude	artnem/ssr.bin		; special stage R block
		align 2
Nem_SS1UpBlock:	binclude	artnem/ss1up.bin	; special stage 1UP block
		align 2
Nem_SSEmStars:	binclude	artnem/ssemstar.bin	; special stage stars from a collected emerald
		align 2
Nem_SSRedWhite:	binclude	artnem/ssredwhi.bin	; special stage red/white block
		align 2
Nem_SSZone1:	binclude	artnem/sszone1.bin	; special stage ZONE1 block
		align 2
Nem_SSZone2:	binclude	artnem/sszone2.bin	; ZONE2 block
		align 2
Nem_SSZone3:	binclude	artnem/sszone3.bin	; ZONE3 block
		align 2
Nem_SSZone4:	binclude	artnem/sszone4.bin	; ZONE4 block
		align 2
Nem_SSZone5:	binclude	artnem/sszone5.bin	; ZONE5 block
		align 2
Nem_SSZone6:	binclude	artnem/sszone6.bin	; ZONE6 block
		align 2
Nem_SSUpDown:	binclude	artnem/ssupdown.bin	; special stage UP/DOWN block
		align 2
Nem_SSEmerald:	binclude	artnem/ssemeral.bin	; special stage chaos emeralds
		align 2
Nem_SSGhost:	binclude	artnem/ssghost.bin	; special stage ghost block
		align 2
Nem_SSWBlock:	binclude	artnem/ssw.bin		; special stage W block
		align 2
Nem_SSGlass:	binclude	artnem/ssglass.bin	; special stage destroyable glass block
		align 2
Nem_ResultEm:	binclude	artnem/ssresems.bin	; chaos emeralds on special stage results screen
		align 2
; ---------------------------------------------------------------------------
; Compressed graphics - GHZ stuff
; ---------------------------------------------------------------------------
Nem_Stalk:	binclude	artnem/ghzstalk.bin	; GHZ flower stalk
		align 2
Nem_Swing:	binclude	artnem/ghzswing.bin	; GHZ swinging platform
		align 2
Nem_Bridge:	binclude	artnem/ghzbridg.bin	; GHZ bridge
		align 2
Nem_GhzUnkBlock:binclude	artnem/xxxghzbl.bin	; unused GHZ block
		align 2
Nem_Ball:	binclude	artnem/ghzball.bin	; GHZ giant ball
		align 2
Nem_Spikes:	binclude	artnem/spikes.bin	; spikes
		align 2
Nem_GhzLog:	binclude	artnem/xxxghzlo.bin	; unused GHZ log
		align 2
Nem_SpikePole:	binclude	artnem/ghzlog.bin	; GHZ spiked log
		align 2
Nem_PplRock:	binclude	artnem/ghzrock.bin	; GHZ purple rock
		align 2
Nem_GhzWall1:	binclude	artnem/ghzwall1.bin	; GHZ destroyable wall
		align 2
Nem_GhzWall2:	binclude	artnem/ghzwall2.bin	; GHZ normal wall
		align 2
; ---------------------------------------------------------------------------
; Compressed graphics - LZ stuff
; ---------------------------------------------------------------------------
Nem_Water:	binclude	artnem/lzwater.bin	; LZ water surface
		align 2
Nem_Splash:	binclude	artnem/lzsplash.bin	; LZ waterfalls and splashes
		align 2
Nem_LzSpikeBall:binclude	artnem/lzspball.bin	; LZ spiked ball on chain
		align 2
Nem_FlapDoor:	binclude	artnem/lzflapdo.bin	; LZ flapping door
		align 2
Nem_Bubbles:	binclude	artnem/lzbubble.bin	; LZ bubbles and countdown numbers
		align 2
Nem_LzBlock3:	binclude	artnem/lzblock3.bin	; LZ 32x16 block
		align 2
Nem_LzDoor1:	binclude	artnem/lzvdoor.bin	; LZ vertical door
		align 2
Nem_Harpoon:	binclude	artnem/lzharpoo.bin	; LZ harpoon
		align 2
Nem_LzPole:	binclude	artnem/lzpole.bin	; LZ pole that breaks
		align 2
Nem_LzDoor2:	binclude	artnem/lzhdoor.bin	; LZ large horizontal door
		align 2
Nem_LzWheel:	binclude	artnem/lzwheel.bin	; LZ wheel from corner of conveyor belt
		align 2
Nem_Gargoyle:	binclude	artnem/lzgargoy.bin	; LZ gargoyle head and spitting fire
		align 2
Nem_LzBlock2:	binclude	artnem/lzblock2.bin	; LZ blocks
		align 2
Nem_LzPlatfm:	binclude	artnem/lzptform.bin	; LZ rising platforms
		align 2
Nem_Cork:	binclude	artnem/lzcork.bin	; LZ cork block
		align 2
Nem_LzBlock1:	binclude	artnem/lzblock1.bin	; LZ 32x32 block
		align 2
; ---------------------------------------------------------------------------
; Compressed graphics - MZ stuff
; ---------------------------------------------------------------------------
Nem_MzMetal:	binclude	artnem/mzmetal.bin	; MZ metal blocks
		align 2
Nem_MzSwitch:	binclude	artnem/mzswitch.bin	; MZ switch
		align 2
Nem_MzGlass:	binclude	artnem/mzglassy.bin	; MZ green glassy block
		align 2
Nem_GhzGrass:	binclude	artnem/xxxgrass.bin	; unused grass (GHZ or MZ?)
		align 2
Nem_MzFire:	binclude	artnem/mzfire.bin	; MZ fireballs
		align 2
Nem_Lava:	binclude	artnem/mzlava.bin	; MZ lava
		align 2
Nem_MzBlock:	binclude	artnem/mzblock.bin	; MZ green pushable block
		align 2
Nem_MzUnkBlock:	binclude	artnem/xxxmzblo.bin	; MZ unused background block
		align 2
; ---------------------------------------------------------------------------
; Compressed graphics - SLZ stuff
; ---------------------------------------------------------------------------
Nem_Seesaw:	binclude	artnem/slzseesa.bin	; SLZ seesaw
		align 2
Nem_SlzSpike:	binclude	artnem/slzspike.bin	; SLZ spikeball that sits on a seesaw
		align 2
Nem_Fan:	binclude	artnem/slzfan.bin	; SLZ fan
		align 2
Nem_SlzWall:	binclude	artnem/slzwall.bin	; SLZ smashable wall
		align 2
Nem_Pylon:	binclude	artnem/slzpylon.bin	; SLZ foreground pylon
		align 2
Nem_SlzSwing:	binclude	artnem/slzswing.bin	; SLZ swinging platform
		align 2
Nem_SlzBlock:	binclude	artnem/slzblock.bin	; SLZ 32x32 block
		align 2
Nem_SlzCannon:	binclude	artnem/slzcanno.bin	; SLZ fireball launcher cannon
		align 2
; ---------------------------------------------------------------------------
; Compressed graphics - SYZ stuff
; ---------------------------------------------------------------------------
Nem_Bumper:	binclude	artnem/syzbumpe.bin	; SYZ bumper
		align 2
Nem_SyzSpike2:	binclude	artnem/syzsspik.bin	; SYZ small spikeball
		align 2
Nem_LzSwitch:	binclude	artnem/switch.bin	; LZ/SYZ/SBZ switch
		align 2
Nem_SyzSpike1:	binclude	artnem/syzlspik.bin	; SYZ/SBZ large spikeball
		align 2
; ---------------------------------------------------------------------------
; Compressed graphics - SBZ stuff
; ---------------------------------------------------------------------------
Nem_SbzWheel1:	binclude	artnem/sbzwhee1.bin	; SBZ spot on rotating wheel that Sonic runs around
		align 2
Nem_SbzWheel2:	binclude	artnem/sbzwhee2.bin	; SBZ wheel that grabs Sonic
		align 2
Nem_Cutter:	binclude	artnem/sbzcutte.bin	; SBZ pizza cutter
		align 2
Nem_Stomper:	binclude	artnem/sbzstomp.bin	; SBZ stomper
		align 2
Nem_SpinPform:	binclude	artnem/sbzpform.bin	; SBZ spinning platform
		align 2
Nem_TrapDoor:	binclude	artnem/sbztrapd.bin	; SBZ trapdoor
		align 2
Nem_SbzFloor:	binclude	artnem/sbzfloor.bin	; SBZ collapsing floor
		align 2
Nem_Electric:	binclude	artnem/sbzshock.bin	; SBZ electric shock orb
		align 2
Nem_SbzBlock:	binclude	artnem/sbzvanis.bin	; SBZ vanishing block
		align 2
Nem_FlamePipe:	binclude	artnem/sbzflame.bin	; SBZ flaming pipe
		align 2
Nem_SbzDoor1:	binclude	artnem/sbzvdoor.bin	; SBZ small vertical door
		align 2
Nem_SlideFloor:	binclude	artnem/sbzslide.bin	; SBZ floor that slides away
		align 2
Nem_SbzDoor2:	binclude	artnem/sbzhdoor.bin	; SBZ large horizontal door
		align 2
Nem_Girder:	binclude	artnem/sbzgirde.bin	; SBZ crushing girder
		align 2
; ---------------------------------------------------------------------------
; Compressed graphics - enemies
; ---------------------------------------------------------------------------
Nem_BallHog:	binclude	artnem/ballhog.bin	; ball hog
		align 2
Nem_Crabmeat:	binclude	artnem/crabmeat.bin	; crabmeat
		align 2
Nem_Buzz:	binclude	artnem/buzzbomb.bin	; buzz bomber
		align 2
Nem_UnkExplode:	binclude	artnem/xxxexplo.bin	; unused explosion
		align 2
Nem_Burrobot:	binclude	artnem/burrobot.bin	; burrobot
		align 2
Nem_Chopper:	binclude	artnem/chopper.bin	; chopper
		align 2
Nem_Jaws:	binclude	artnem/jaws.bin		; jaws
		align 2
Nem_Roller:	binclude	artnem/roller.bin	; roller
		align 2
Nem_Motobug:	binclude	artnem/motobug.bin	; moto bug
		align 2
Nem_Newtron:	binclude	artnem/newtron.bin	; newtron
		align 2
Nem_Yadrin:	binclude	artnem/yadrin.bin	; yadrin
		align 2
Nem_Basaran:	binclude	artnem/basaran.bin	; basaran
		align 2
Nem_Splats:	binclude	artnem/splats.bin	; splats
		align 2
Nem_Bomb:	binclude	artnem/bomb.bin		; bomb
		align 2
Nem_Orbinaut:	binclude	artnem/orbinaut.bin	; orbinaut
		align 2
Nem_Cater:	binclude	artnem/caterkil.bin	; caterkiller
		align 2
; ---------------------------------------------------------------------------
; Compressed graphics - various
; ---------------------------------------------------------------------------
Nem_TitleCard:	binclude	artnem/ttlcards.bin	; title cards
		align 2
Nem_Hud:	binclude	artnem/hud.bin		; HUD (rings, time, score)
		align 2
Nem_Lives:	binclude	artnem/lifeicon.bin	; life counter icon
		align 2
Nem_Ring:	binclude	artnem/rings.bin	; rings
		align 2
Nem_Monitors:	binclude	artnem/monitors.bin	; monitors
		align 2
Nem_Explode:	binclude	artnem/explosio.bin	; explosion
		align 2
Nem_Points:	binclude	artnem/points.bin	; points from destroyed enemy or object
		align 2
Nem_GameOver:	binclude	artnem/gameover.bin	; game over / time over
		align 2
Nem_HSpring:	binclude	artnem/springh.bin	; horizontal spring
		align 2
Nem_VSpring:	binclude	artnem/springv.bin	; vertical spring
		align 2
Nem_SignPost:	binclude	artnem/signpost.bin	; end of level signpost
		align 2
Nem_Lamp:	binclude	artnem/lamppost.bin	; lamppost
		align 2
Nem_BigFlash:	binclude	artnem/rngflash.bin	; flash from giant ring
		align 2
Nem_Bonus:	binclude	artnem/bonus.bin	; hidden bonuses at end of a level
		align 2
; ---------------------------------------------------------------------------
; Compressed graphics - continue screen
; ---------------------------------------------------------------------------
Nem_ContSonic:	binclude	artnem/cntsonic.bin	; Sonic on continue screen
		align 2
Nem_MiniSonic:	binclude	artnem/cntother.bin	; mini Sonic and text on continue screen
		align 2
; ---------------------------------------------------------------------------
; Compressed graphics - animals
; ---------------------------------------------------------------------------
Nem_Rabbit:	binclude	artnem/rabbit.bin	; rabbit
		align 2
Nem_Chicken:	binclude	artnem/chicken.bin	; chicken
		align 2
Nem_BlackBird:	binclude	artnem/blackbrd.bin	; blackbird
		align 2
Nem_Seal:	binclude	artnem/seal.bin		; seal
		align 2
Nem_Pig:	binclude	artnem/pig.bin		; pig
		align 2
Nem_Flicky:	binclude	artnem/flicky.bin	; flicky
		align 2
Nem_Squirrel:	binclude	artnem/squirrel.bin	; squirrel
		align 2
; ---------------------------------------------------------------------------
...
Blk16_GHZ:	binclude	map16/ghz.bin
		align 2
Nem_GHZ_1st:	binclude	artnem/8x8ghz1.bin	; GHZ primary patterns
		align 2
Nem_GHZ_2nd:	binclude	artnem/8x8ghz2.bin	; GHZ secondary patterns
		align 2
Blk256_GHZ:	binclude	map256/ghz.bin
		align 2
Blk16_LZ:	binclude	map16/lz.bin
		align 2
Nem_LZ:		binclude	artnem/8x8lz.bin	; LZ primary patterns
		align 2
Blk256_LZ:	binclude	map256/lz.bin
		align 2
Blk16_MZ:	binclude	map16/mz.bin
		align 2
Nem_MZ:		binclude	artnem/8x8mz.bin	; MZ primary patterns
		align 2
Blk256_MZ:	binclude	map256/mz.bin
		align 2
Blk16_SLZ:	binclude	map16/slz.bin
		align 2
Nem_SLZ:	binclude	artnem/8x8slz.bin	; SLZ primary patterns
		align 2
Blk256_SLZ:	binclude	map256/slz.bin
		align 2
Blk16_SYZ:	binclude	map16/syz.bin
		align 2
Nem_SYZ:	binclude	artnem/8x8syz.bin	; SYZ primary patterns
		align 2
Blk256_SYZ:	binclude	map256/syz.bin
		align 2
Blk16_SBZ:	binclude	map16/sbz.bin
		align 2
Nem_SBZ:	binclude	artnem/8x8sbz.bin	; SBZ primary patterns
		align 2
...
; ---------------------------------------------------------------------------
Nem_Eggman:	binclude	artnem/bossmain.bin	; boss main patterns
		align 2
Nem_Weapons:	binclude	artnem/bossxtra.bin	; boss add-ons and weapons
		align 2
Nem_Prison:	binclude	artnem/prison.bin	; prison capsule
		align 2
Nem_Sbz2Eggman:	binclude	artnem/sbz2boss.bin	; Eggman in SBZ2 and FZ
		align 2
Nem_FzBoss:	binclude	artnem/fzboss.bin	; FZ boss
		align 2
Nem_FzEggman:	binclude	artnem/fzboss2.bin	; Eggman after the FZ boss
		align 2
Nem_Exhaust:	binclude	artnem/bossflam.bin	; boss exhaust flame
		align 2
Nem_EndEm:	binclude	artnem/endemera.bin	; ending sequence chaos emeralds
		align 2
Nem_EndSonic:	binclude	artnem/endsonic.bin	; ending sequence Sonic
		align 2
Nem_TryAgain:	binclude	artnem/tryagain.bin	; ending "try again" screen
		align 2
Nem_EndEggman:	binclude	artnem/xxxend.bin	; unused boss sequence on ending
		align 2
Kos_EndFlowers:	binclude	artkos/flowers.bin	; ending sequence animated flowers
		align 2
Nem_EndFlower:	binclude	artnem/endflowe.bin	; ending sequence flowers
		align 2
Nem_CreditText:	binclude	artnem/credits.bin	; credits alphabet
		align 2
Nem_EndStH:	binclude	artnem/endtext.bin	; ending sequence "Sonic the Hedgehog" text
		align 2
		rept $104
		dc.b $FF			; why?
		endm
...
; Collision data
; ---------------------------------------------------------------------------
AngleMap:	binclude	collide/anglemap.bin	; floor angle map
		align 2
CollArray1:	binclude	collide/carray_n.bin	; normal collision array
		align 2
...
; ---------------------------------------------------------------------------
Art_GhzWater:	binclude	artunc/ghzwater.bin	; GHZ waterfall
		align 2
Art_GhzFlower1:	binclude	artunc/ghzflowl.bin	; GHZ large flower
		align 2
Art_GhzFlower2:	binclude	artunc/ghzflows.bin	; GHZ small flower
		align 2
Art_MzLava1:	binclude	artunc/mzlava1.bin	; MZ lava surface
		align 2
Art_MzLava2:	binclude	artunc/mzlava2.bin	; MZ lava
		align 2
Art_MzTorch:	binclude	artunc/mztorch.bin	; MZ torch in background
		align 2
Art_SbzSmoke:	binclude	artunc/sbzsmoke.bin	; SBZ smoke in background
		align 2
...
; ---------------------------------------------------------------------------
Art_BigRing:	binclude	artunc/bigring.bin
		align 2
...
; ---------------------------------------------------------------------------
; ObjPos_Index:
Off_Objects:	dc.w ObjPos_GHZ1-Off_Objects, ObjPos_Null-Off_Objects
		dc.w ObjPos_GHZ2-Off_Objects, ObjPos_Null-Off_Objects
		dc.w ObjPos_GHZ3-Off_Objects, ObjPos_Null-Off_Objects
		dc.w ObjPos_GHZ1-Off_Objects, ObjPos_Null-Off_Objects
		dc.w ObjPos_LZ1-Off_Objects, ObjPos_Null-Off_Objects
		dc.w ObjPos_LZ2-Off_Objects, ObjPos_Null-Off_Objects
		dc.w ObjPos_LZ3-Off_Objects, ObjPos_Null-Off_Objects
		dc.w ObjPos_SBZ3-Off_Objects, ObjPos_Null-Off_Objects
		dc.w ObjPos_MZ1-Off_Objects, ObjPos_Null-Off_Objects
		dc.w ObjPos_MZ2-Off_Objects, ObjPos_Null-Off_Objects
		dc.w ObjPos_MZ3-Off_Objects, ObjPos_Null-Off_Objects
		dc.w ObjPos_MZ1-Off_Objects, ObjPos_Null-Off_Objects
		dc.w ObjPos_SLZ1-Off_Objects, ObjPos_Null-Off_Objects
		dc.w ObjPos_SLZ2-Off_Objects, ObjPos_Null-Off_Objects
		dc.w ObjPos_SLZ3-Off_Objects, ObjPos_Null-Off_Objects
		dc.w ObjPos_SLZ1-Off_Objects, ObjPos_Null-Off_Objects
		dc.w ObjPos_SYZ1-Off_Objects, ObjPos_Null-Off_Objects
		dc.w ObjPos_SYZ2-Off_Objects, ObjPos_Null-Off_Objects
		dc.w ObjPos_SYZ3-Off_Objects, ObjPos_Null-Off_Objects
		dc.w ObjPos_SYZ1-Off_Objects, ObjPos_Null-Off_Objects
		dc.w ObjPos_SBZ1-Off_Objects, ObjPos_Null-Off_Objects
		dc.w ObjPos_SBZ2-Off_Objects, ObjPos_Null-Off_Objects
		dc.w ObjPos_FZ-Off_Objects, ObjPos_Null-Off_Objects
		dc.w ObjPos_SBZ1-Off_Objects, ObjPos_Null-Off_Objects
		dc.w ObjPos_End-Off_Objects, ObjPos_Null-Off_Objects
		dc.w ObjPos_End-Off_Objects, ObjPos_Null-Off_Objects
		dc.w ObjPos_End-Off_Objects, ObjPos_Null-Off_Objects
		dc.w ObjPos_End-Off_Objects, ObjPos_Null-Off_Objects
		dc.w ObjPos_LZ1pf1-Off_Objects, ObjPos_LZ1pf2-Off_Objects
		dc.w ObjPos_LZ2pf1-Off_Objects, ObjPos_LZ2pf2-Off_Objects
		dc.w ObjPos_LZ3pf1-Off_Objects, ObjPos_LZ3pf2-Off_Objects
		dc.w ObjPos_LZ1pf1-Off_Objects, ObjPos_LZ1pf2-Off_Objects
		dc.w ObjPos_SBZ1pf1-Off_Objects, ObjPos_SBZ1pf2-Off_Objects
		dc.w ObjPos_SBZ1pf3-Off_Objects, ObjPos_SBZ1pf4-Off_Objects
		dc.w ObjPos_SBZ1pf5-Off_Objects, ObjPos_SBZ1pf6-Off_Objects
		dc.w ObjPos_SBZ1pf1-Off_Objects, ObjPos_SBZ1pf2-Off_Objects
		dc.b $FF, $FF, 0, 0, 0,	0
